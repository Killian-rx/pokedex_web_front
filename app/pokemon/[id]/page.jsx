...
import { getPokemonWithTranslations } from "../../../src/services/pokeapi.js";
...
export default function DetailsPage() {
  ...
  useEffect(() => {
    const loadPokemon = async () => {
      ...
      setError(null);
      try {
        const data = await getPokemonWithTranslations(parseInt(id));
        setPokemon(data);
      } catch (err) {
        console.error('Error loading pokemon:', err);
        setError('Pokémon introuvable');
        // Rediriger vers la page not-found après un court délai
        setTimeout(() => {
  ...
  if (isLoading) {
    // Le loading.tsx sera affiché automatiquement pendant le chargement
    return null;
  }
